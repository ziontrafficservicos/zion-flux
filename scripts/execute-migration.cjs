/**
 * Script para executar a migration sieg_fin_* no banco Supabase
 * Usa a Management API para executar SQL diretamente
 * Banco: zfgezrwksmuhnrmudnas (Banco Zion)
 *
 * Autor: DB Sage (JARVIS)
 * Data: 2026-03-21
 */

const SUPABASE_PROJECT_REF = 'zfgezrwksmuhnrmudnas';
const SUPABASE_ACCESS_TOKEN = 'sbp_ecf3c1f4ada2915a5f211ede4cae8df38d052dd6';
...
async function executeSQL(sql, label) {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return { success: false, error: text, label };
    }

    console.log(`  OK - Executado com sucesso`);
    return { success: true, result: text, label };
  } catch (error) {
...
async function main() {
  console.log('============================================================');
  console.log('MIGRATION SIEG_FIN_* - Banco Zion (zfgezrwksmuhnrmudnas)');
  console.log('Data: 2026-03-21');
  console.log('============================================================');

  const results = [];

  // =====================================================
  // BLOCO 1: Tabela principal sieg_fin_empresas
  // =====================================================
...
CREATE TABLE IF NOT EXISTS public.sieg_fin_tenant_users (
  ...
  `, '2. sieg_fin_tenant_users'));

  // =====================================================
  // BLOCO 3: sieg_fin_membros_workspace
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_membros_workspace (
  ...
  `, '3. sieg_fin_membros_workspace'));

  // =====================================================
  // BLOCO 4: sieg_fin_pending_invites
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_pending_invites (
  ...
  `, '4. sieg_fin_pending_invites'));

  // =====================================================
  // BLOCO 5: sieg_fin_configuracoes_banco
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_configuracoes_banco (
  ...
  `, '5. sieg_fin_configuracoes_banco'));

  // =====================================================
  // BLOCO 6: sieg_fin_financeiro
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_financeiro (
  ...
  `, '6. sieg_fin_financeiro'));

  // =====================================================
  // BLOCO 7: sieg_fin_atualizacao_geral
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_atualizacao_geral (
  ...
  `, '7. sieg_fin_atualizacao_geral'));

  // =====================================================
  // BLOCO 8: sieg_fin_conversas_leads
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_conversas_leads (
  ...
  `, '8. sieg_fin_conversas_leads'));

  // =====================================================
  // BLOCO 9: sieg_fin_leads
  // =====================================================
  results.push(await executeSQL(`
...
CREATE TABLE IF NOT EXISTS public.sieg_fin_disparos (
  ...
  `, '10. sieg_fin_disparos'));

  // =====================================================
  // BLOCO 11: sieg_fin_historico_tags_lead
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_historico_tags_lead (
  ...
  `, '11. sieg_fin_historico_tags_lead'));

  // =====================================================
  // BLOCO 12: sieg_fin_historico_tags_financeiros
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_historico_tags_financeiros (
  ...
  // =====================================================
  // BLOCO 13: sieg_fin_historico_valores_financeiros
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_historico_valores_financeiros (
  ...
  // =====================================================
  // BLOCO 14: sieg_fin_mapeamentos_tags_tenant
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_mapeamentos_tags_tenant (
  ...
  // =====================================================
  // BLOCO 15: sieg_fin_custos_anuncios_tenant
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_custos_anuncios_tenant (
  ...
  // =====================================================
  // BLOCO 16: sieg_fin_contas_meta_ads
  // =====================================================
  results.push(await executeSQL(`
...
CREATE TABLE IF NOT EXISTS public.sieg_fin_audit_log (
  ...
  // =====================================================
  // BLOCO 18: sieg_fin_auditoria_sistema
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_auditoria_sistema (
  ...
  `, '18. sieg_fin_auditoria_sistema'));

  // =====================================================
  // BLOCO 19: sieg_fin_campanhas
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_campanhas (
  ...
  // =====================================================
  // BLOCO 20: sieg_fin_eventos_lead
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_eventos_lead (
  ...
  // =====================================================
  // BLOCO 21: sieg_fin_consentimento_lgpd
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_consentimento_lgpd (
  ...
  // =====================================================
  // BLOCO 22: sieg_fin_solicitacoes_lgpd
  // =====================================================
  results.push(await executeSQL(`
...
CREATE TABLE IF NOT EXISTS public.sieg_fin_leads_asf (
  ...
  // =====================================================
  // BLOCO 24: sieg_fin_leads_asf_ofc
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_leads_asf_ofc (
  ...
  // =====================================================
  // BLOCO 25: sieg_fin_leads_dr_premium
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_leads_dr_premium (
  ...
  // =====================================================
  // BLOCO 26: sieg_fin_leads_dr_premium_tags
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_leads_dr_premium_tags (
  ...
  // =====================================================
  // BLOCO 27: sieg_fin_n8n_chat_histories
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_n8n_chat_histories (
  ...
  // =====================================================
  // BLOCO 28: sieg_fin_confirmacao_inscricao
  // =====================================================
  results.push(await executeSQL(`
...
CREATE TABLE IF NOT EXISTS public.sieg_fin_superlive (
  ...
  // =====================================================
  // BLOCO 30: sieg_fin_user_settings
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_user_settings (
  ...
  `, '30. sieg_fin_user_settings'));

  // =====================================================
  // BLOCO 31: sieg_fin_analise_ia
  // =====================================================
  results.push(await executeSQL(`
CREATE TABLE IF NOT EXISTS public.sieg_fin_analise_ia (
  ...
  `, '31. sieg_fin_analise_ia'));

  // =====================================================
  // BLOCO 32: sieg_fin_analise_fluxos
  // =====================================================
  results.push(await executeSQL(`
...
FROM public.sieg_fin_configuracoes_banco;
  `, 'VIEW: sieg_fin_database_configs'));
...
FROM public.sieg_fin_contas_meta_ads;
  `, 'VIEW: sieg_fin_meta_ads_accounts'));
...
END;
$$ LANGUAGE plpgsql;
  `, 'FUNCTION: sieg_fin_update_updated_at'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_is_workspace_member'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_get_user_workspaces'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_get_workspace_members_with_details'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_kpi_totais_periodo'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_get_audit_logs'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_count_audit_logs'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_contar_disparos_por_status'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_contar_disparos_por_dia'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_registrar_auditoria'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_deletar_usuario_completo'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_get_user_permissions'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_save_user_permissions'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_get_atendimentos_metrics'));
...
END;
$$;
  `, 'FUNCTION: sieg_fin_update_conversation_tag'));
...
ALTER TABLE public.sieg_fin_pending_invites ENABLE ROW LEVEL SECURITY;
  ...
  // =====================================================
  // RLS POLICIES (com DROP IF EXISTS antes de cada CREATE)
  // NOTA: A policy sieg_fin_tenant_users_all_owner foi REMOVIDA
  //       por risco de referência circular (consulta a própria tabela com RLS)
  //       Substituída por policy baseada em auth.uid() direto
  // =====================================================
  results.push(await executeSQL(`
DO $$
BEGIN
  -- Drop existing policies first (idempotent)
  DROP POLICY IF EXISTS "sieg_fin_tenant_users_select" ON public.sieg_fin_tenant_users;
  DROP POLICY IF EXISTS "sieg_fin_tenant_users_all_owner" ON public.sieg_fin_tenant_users;
  DROP POLICY IF EXISTS "sieg_fin_empresas_select" ON public.sieg_fin_empresas;
  DROP POLICY IF EXISTS "sieg_fin_financeiro_select" ON public.sieg_fin_financeiro;
  DROP POLICY IF EXISTS "sieg_fin_conversas_leads_select" ON public.sieg_fin_conversas_leads;
  DROP POLICY IF EXISTS "sieg_fin_leads_select" ON public.sieg_fin_leads;
  DROP POLICY IF EXISTS "sieg_fin_disparos_select" ON public.sieg_fin_disparos;
  DROP POLICY IF EXISTS "sieg_fin_audit_log_select" ON public.sieg_fin_audit_log;
  DROP POLICY IF EXISTS "sieg_fin_pending_invites_select" ON public.sieg_fin_pending_invites;
  DROP POLICY IF EXISTS "sieg_fin_tenant_users_insert_owner" ON public.sieg_fin_tenant_users;
  DROP POLICY IF EXISTS "sieg_fin_tenant_users_update_owner" ON public.sieg_fin_tenant_users;
  DROP POLICY IF EXISTS "sieg_fin_tenant_users_delete_owner" ON public.sieg_fin_tenant_users;
END $$;
  `, 'DROP EXISTING POLICIES'));

  // tenant_users: SELECT own records
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_tenant_users_select" ON public.sieg_fin_tenant_users
  FOR SELECT USING (user_id = auth.uid());
  `, 'POLICY: sieg_fin_tenant_users_select'));

  // tenant_users: INSERT/UPDATE/DELETE for owners/admins
  // Usando SECURITY DEFINER function para evitar referencia circular
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_tenant_users_insert_owner" ON public.sieg_fin_tenant_users
  FOR INSERT WITH CHECK (
    public.sieg_fin_is_workspace_member(auth.uid(), tenant_id)
  );
  `, 'POLICY: sieg_fin_tenant_users_insert_owner'));

  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_tenant_users_update_owner" ON public.sieg_fin_tenant_users
  FOR UPDATE USING (
    public.sieg_fin_is_workspace_member(auth.uid(), tenant_id)
  );
  `, 'POLICY: sieg_fin_tenant_users_update_owner'));

  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_tenant_users_delete_owner" ON public.sieg_fin_tenant_users
  FOR DELETE USING (
    public.sieg_fin_is_workspace_member(auth.uid(), tenant_id)
  );
  `, 'POLICY: sieg_fin_tenant_users_delete_owner'));

  // empresas: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_empresas_select" ON public.sieg_fin_empresas
  FOR SELECT USING (
    public.sieg_fin_is_workspace_member(auth.uid(), id)
  );
  `, 'POLICY: sieg_fin_empresas_select'));

  // financeiro: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_financeiro_select" ON public.sieg_fin_financeiro
  ...
  `, 'POLICY: sieg_fin_financeiro_select'));

  // conversas_leads: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_conversas_leads_select" ON public.sieg_fin_conversas_leads
  ...
  `, 'POLICY: sieg_fin_conversas_leads_select'));

  // leads: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_leads_select" ON public.sieg_fin_leads
  ...
  `, 'POLICY: sieg_fin_leads_select'));

  // disparos: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_disparos_select" ON public.sieg_fin_disparos
  ...
  `, 'POLICY: sieg_fin_disparos_select'));

  // audit_log: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_audit_log_select" ON public.sieg_fin_audit_log
  ...
  `, 'POLICY: sieg_fin_audit_log_select'));

  // pending_invites: SELECT for members
  results.push(await executeSQL(`
CREATE POLICY "sieg_fin_pending_invites_select" ON public.sieg_fin_pending_invites
  ...
  `, 'POLICY: sieg_fin_pending_invites_select'));

  // =====================================================
  // RELATORIO FINAL
  // =====================================================
  console.log('\n\n============================================================');
  console.log('RELATORIO FINAL DA MIGRATION');
  console.log('============================================================\n');

  const successful = results.filter(r => r.success);
  const failed = results.filter(r => !r.success);

  console.log(`Total de operacoes: ${results.length}`);
  ...
  if (failed.length > 0) {
    console.log('\n--- FALHAS ---');
    failed.forEach(r => {
      console.log(`  [FALHA] ${r.label}: ${r.error}`);
    });
  }
